...
class EndBet_ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView){
    ...
    fun bind(post: EndBet, databaseReference: DatabaseReference, viewHolder: EndBet_ViewHolder, theactivity: FragmentActivity) {
        ...
        clear_up_button.setSafeOnClickListener {
            ...
            FirebaseDatabase.getInstance().getReference().child("streams").child(theselected_id).child("answer").addListenerForSingleValueEvent(object:
                ValueEventListener {
                ...
                override fun onDataChange(snapshot: DataSnapshot) {
                    if (!snapshot.exists()) {
                        ...
                        FirebaseDatabase.getInstance().getReference().child("streams").child(theselected_id).child("stamp")
                                    ...
                                    FirebaseDatabase.getInstance().getReference().child("bets").addListenerForSingleValueEvent(object:
                                        ...
                                        override fun onDataChange(snapshot: DataSnapshot) {
                                            FirebaseDatabase.getInstance().reference.child("keys").child(theselected_id).addListenerForSingleValueEvent(object: ValueEventListener{
                                                ...
                                                override fun onDataChange(theshot: DataSnapshot) {
                                                    if (theshot.exists()) {
                                                        val actual_id = theshot.value.toString()
                                                            ...
                                                            FirebaseDatabase.getInstance().getReference().child("bets").child(key.toString()).addListenerForSingleValueEvent(object :
                                                                ...
                                                                override fun onDataChange(snapshot: DataSnapshot) {
                                                                    for (value in snapshot.children) {
                                                                        ...
                                                                        FirebaseDatabase.getInstance().getReference().child("bets").child(actual_id).child(new_Key.toString()).child("stamp").addListenerForSingleValueEvent(
                                                                            object : ValueEventListener {
                                                                                ...
                                                                                override fun onDataChange(snapshot: DataSnapshot) {
                                                                                    ...
                                                                                    FirebaseDatabase.getInstance().getReference().child("bets").child(key.toString()).child(new_Key.toString()).addListenerForSingleValueEvent(object:
                                                                                        ValueEventListener {
                                                                                        override fun onCancelled(error: DatabaseError) {
                                                                                            if (progressDialog.isShowing) {progressDialog.dismiss()}                               
                                                                                            theactivity.makeLongToast(error.message)
                                                                                        ...
                                                                                        override fun onDataChange(levelone_snapshot: DataSnapshot) {
                                                                                            if (levelone_snapshot.exists()) {
                                                                                                ...
                                                                                                FirebaseDatabase.getInstance().getReference().child("streams").child( theselected_id).addListenerForSingleValueEvent(object :
                                                                                                    ValueEventListener {
                                                                                                    override fun onCancelled(error: DatabaseError) {
                                                                                                        if (progressDialog.isShowing) {progressDialog.dismiss()}                               
                                                                                                    ...
                                                                                                    override fun onDataChange(snapshot: DataSnapshot) {
                                                                                                        if (snapshot.exists()) {
                                                                                                            ...
                                                                                                            FirebaseDatabase.getInstance().getReference().child("users").child(hostid).addListenerForSingleValueEvent(object :
                                                                                                                ValueEventListener {
                                                                                                                override fun onCancelled(error: DatabaseError) {
                                                                                                                    if (progressDialog.isShowing) {progressDialog.dismiss()}                               
                                                                                                                    theactivity.makeLongToast(error.message)
                                                                                                                                ...
                                                                                                                                .addOnCompleteListener {
                                                                                                                                    if (it.isComplete) {
                                                                                                                                        ...
                                                                                                                                        if (!hechose.equals(correct_anser)) {
                                                                                                                                            sendNotification(theselected_id, "You lost:       Bet: $tittle")
                                                                                                                                            win_or_lose = "Lost"

                                                                                                                                        } else {
                                                                                                                                            sendNotification(theselected_id, "You Won:      Bet: $tittle,    Stream will contact you for payment.")
                                                                                                                                            win_or_lose = "Won"
                                                                                                                                        }

                                                                                                                                        val tagMap = HashMap<String, String>()
                                                                                                                                        tagMap["tag"]  = theselected_id

                                                                                                                                        val moneyMap = HashMap<String, Any>()
                                                                                                                                        moneyMap["hostname"] = host_end_name
                                                                                                                                        moneyMap["hostmobile"] = host_end_mobile
                                                                                                                                        moneyMap["hostemail"] = host_end_email
                                                                                                                                        moneyMap["role"] = "Host"
                                                                                                                                        moneyMap["bettername"] = end_name
                                                                                                                                        moneyMap["bettermobile"] = end_mobile
                                                                                                                                        moneyMap["betteremail"] = end_email
                                                                                                                                        moneyMap["betteramount"] = end_bettamount
                                                                                                                                        moneyMap["betterchoice"] = end_bettchoice
                                                                                                                                        moneyMap["betterrole"] = "Regular"
                                                                                                                                        moneyMap["title"] = tittle
                                                                                                                                        moneyMap["wonorlost"] = win_or_lose
                                                                                                                                        moneyMap["correctanswer"] = correct_anser
                                                                                                                                        ...
                                                                                                                                        FirebaseDatabase.getInstance().reference.child("keys").child(theselected_id).addListenerForSingleValueEvent(object: ValueEventListener{
                                                                                                                                            ...
                                                                                                                                            override fun onDataChange(keysnapshot: DataSnapshot) {
                                                                                                                                                if (keysnapshot.exists()) {
                                                                                                                                                    val theid = keysnapshot.value.toString()

                                                                                                                                                    FirebaseDatabase.getInstance().reference.child("ids").child(theid).child(theselected_id).removeValue().addOnCompleteListener {
                                                                                                                                                        if (it.isSuccessful) {

                                                                                                                                                        } else {
                                                                                                                                                            if (progressDialog.isShowing) {progressDialog.dismiss()}                               
                                                                                                                                                            theactivity.makeLongToast("Exception: ${it.exception.toString()}")
                                                                                                                                                        }
                                                                                                                                                    }

                                                                                                                                                } else {
                                                                                                                                                    if (progressDialog.isShowing) {progressDialog.dismiss()}                               
                                                                                                                                                    theactivity.makeLongToast("Missing Id!")
                                                                                                                                                }
                                                                                                                                            }
                                                                                                                                        })

                                                                                                                                        FirebaseChecker().homeRef_Streams.child(
                                                                                                                                            theselected_id).removeValue().addOnCompleteListener {
                                                                                                                                            if (it.isSuccessful) {
                                                        ...
                                                        val collectionref: CollectionReference = Constants.database.collection("streams").document(theselected_id).collection("options")
                                                        collectionref.get().addOnCompleteListener {
                                                            if (it.isSuccessful) {
                                                                for (document in it.result!!) {
                                                                    val thedocumentid = document.id
                                                                    val ref: DocumentReference = Constants.database.collection("streams").document(theselected_id).collection("options").document(thedocumentid)
                                                                    ref.delete()
                                                                }

                                                                val ref: DocumentReference = Constants.database.collection("streams").document(theselected_id)
