...
class OptionsViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView){
    ...
    fun bind(
        ...
        optionsDisplayName.setSafeOnClickListener {
            ...
            theactivity.showAlertDialog(
                "Option ${
                    optionsDisplayName.text.toString().toUpperCase()
                } has been set."
            )
        }
        ...
        submit_Button?.setSafeOnClickListener {
            ...
            FirebaseDatabase.getInstance().reference.child("users").child(firebaseAuth.currentUser.uid).addListenerForSingleValueEvent(
                    object : ValueEventListener {
                        ...
                        override fun onDataChange(snapshot: DataSnapshot) {
                            if (snapshot.exists() && snapshot.hasChildren()) {
                                ...
                                } else if (betamount.text.toString().equals("")) {
                                    theactivity.makeLongToast("You have to enter a betting amount")
                                } else {
                                    var actual_bet_Amount = betamount?.text.toString().trim().toInt()
                                    FirebaseDatabase.getInstance().reference.child("credentials")
                                        .child("minimummpesaamount").addListenerForSingleValueEvent(
                                                object : ValueEventListener {
                                                    override fun onCancelled(error: DatabaseError) {
                                ...
                                .addListenerForSingleValueEvent(object : ValueEventListener {
                                    ...
                                    override fun onDataChange(snapshot: DataSnapshot) {
                                        if (snapshot.exists()) {
                                            ...
                                            val formatter =
                                                SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss.SSSZZZZZ")
                                            val final_current_day: Date =
                                                formatter.parse(thecurrent_day)
                                            ...
                                            if (final_last_day.compareTo(final_current_day) < 0) {
                                                ...
                                                place_your_bet_open_edt =
                                                    source?.findViewById(R.id.place_your_bet_open_edt)!!
                                                ...
                                                FirebaseDatabase.getInstance().getReference()
                                                    .child("streams").child(Constants.selected_id)
                                                    .child("bets").child(
                                                        ...
                                                        override fun onDataChange(snapshot: DataSnapshot) {
                                                            if (snapshot.exists()) {
                                                                ...
                                                                val user_Option =
                                                                    place_your_bet_open_edt?.text.toString()
                                                                        .trim()

                                                                betamount =
                                                                    source?.findViewById(R.id.amount_placed_for_the_bet)
                                                                var actual_bet_Amount =
                                                                    betamount?.text.toString().trim()
                                                                ...
                                                                if (actual_bet_Amount == "" || actual_bet_Amount == "None") {
                                                                    ...
                                                                    databaseReference.parent!!.parent!!.child(
                                                                            "joinnumber"
                                                                    )
                                                                                                        ...
                                                                                                        object :
                                                                                                            ...
                                                                                                            override fun onDataChange(
                                                                                                                ...
                                                                                                                FirebaseChecker().load_All {
                                                                                                                    ...
                                                                                                                    val streamid =
                                                                                                                        Constants.selected_id
                                                                                                                    val bettamount =
                                                                                                                        actual_bet_Amount

                                                                                                                    //Load the title using the Stream Id.
                                                                                                                    FirebaseChecker().load_selected_Streamer_Stream(
                                                                                                                            streamid
                                                                                                                    ) {
                                                                                                                        ...
                                                                                                                        hashMap_Selected_Bet_By_Better["betttittle"] =
                                                                                                                            thetittle
                                                                                                                        hashMap_Selected_Bet_By_Better["stamp"] =
                                                                                                                            stamp
                                                                                                                        hashMap_Selected_Bet_By_Better["betterimage"] =
                                                                                                                            betterimage
                                                                                                                        hashMap_Selected_Bet_By_Better["bettermobile"] =
                                                                                                                            bettermobile
                                                                                                                        hashMap_Selected_Bet_By_Better["betteremail"] =
                                                                                                                            betteremail
                                                                                                                        hashMap_Selected_Bet_By_Better["betterid"] =
                                                                                                                            betterid
                                                                                                                        hashMap_Selected_Bet_By_Better["betteridnumber"] =
                                                                                                                            betteridnumber
                                                                                                                        hashMap_Selected_Bet_By_Better["streamid"] =
                                                                                                                            streamid
                                                                                                                        hashMap_Selected_Bet_By_Better["bettamount"] =
                                                                                                                            bettamount
                                                                                                                        hashMap_Selected_Bet_By_Better["bettdate"] =
                                                                                                                            currentDate
                                                                                                                        hashMap_Selected_Bet_By_Better["bettstate"] =
                                                                                                                            "Open"
                                                                                                                        hashMap_Selected_Bet_By_Better["bettername"] =
                                                                                                                            bettername
                                                                                                                        ...
                                                                                                                        if (user_Option != "") {
                                                                                                                                        ...
                                                                                                                                        object :
                                                                                                                                            ...
                                                                                                                                            override fun onDataChange(
                                                                                                                                                ...
                                                                                                                                                if (snapshot.exists()) {
                                                                                                                                                                ...
                                                                                                                                                                object :
                                                                                                                                                                    ...
                                                                                                                                                                    override fun onDataChange(
                                                                                                                                                                        ...
                                                                                                                                                                        if (snapshot.exists() && snapshot.childrenCount > maximum_Number) {
                                                                                                                                                                            theactivity.showAlertDialog(
                                                                                                                                                                                    "Maximum number of options reached for this Stream"
                                                                                                                                                                            )
                                                                                                                                                                            if (progressDialog.isShowing) {
                                                                                                                                                                                progressDialog.dismiss()
                                                                                                                                                                            }
                                                                                                                                                                            ...
                                                                                                                                                                            alert =
                                                                                                                                                                                AlertDialog.Builder(
                                                                                                                                                                                    ...
                                                                                                                                                                                    .setMessage(
                                                                                                                                                                                            "Would you like to bet on the option you entered?"
                                                                                                                                                                                    )
                                                                                                                                                                                    .setIcon(
                                                                                                                                                                                            R.drawable.mainicon
                                                                                                                                                                                    )
                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                        if (!middleList.isEmpty()) {
                                                                                                                                                                                                                            for (value in alphabetical_List) {
                                                                                                                                                                                                                                if (value in middleList) {
                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                    hashMap_Selected_Bet_By_Better["streamoption"] =
                                                                                                                                                                                                                                        value
                                                                                                                                                                                                                                    break
                                                                                                                                                                                                                                }
                                                                                                                                                                                                                            }
                                                                                                                                                    ...
                                                                                                                                                    theactivity.showAlertDialog(
                                                                                                                                                            "Very important betting profile information missing"
                                                                                                                                                    )
                                                                                                                                                    if (progressDialog.isShowing) {
                                                                                                                                                        progressDialog.dismiss()
                                                                                                                                                    }
                                                                                                                            ...
                                                                                                                            if (hashMap_Selected_Bet_By_Better == null || hashMap_Selected_Bet_By_Better["streamoption"] == "" || hashMap_Selected_Bet_By_Better["streamoption"] == null) {
                                                                                                                                theactivity.showAlertDialog(
                                                                                                                                        "You have to select at least one betting option or enter your own"
                                                                                                                                )
                                                                                                                                if (progressDialog.isShowing) {
                                                                                                                                    progressDialog.dismiss()
                                                                                                                                }
    ...
    private fun makePayPal_Request(
        theactivity: FragmentActivity,
        source: View,
        bettamount: String,
        bettername: String,
        ...
        val payment = PayPalPayment(
            bettamount.toBigDecimal(),
            "USD",
            "Course Fees",
            PayPalPayment.PAYMENT_INTENT_SALE
        )
        // Creating Paypal Payment activity intent
        val intent = Intent(theactivity, PaymentActivity::class.java)
        //putting the paypal configuration to the intent
        intent.putExtra(PayPalService.EXTRA_PAYPAL_CONFIGURATION, Constants.configd);
        // Puting paypal payment to the intent
        intent.putExtra(PaymentActivity.EXTRA_PAYMENT, payment);
        // the request code will be used on the method onActivityResult
        theactivity.startActivityForResult(intent, Constants.PAYPAL_REQUEST_CODE);
    }
    ...
    private fun make_Mpesa_Request(
        theactivity: FragmentActivity,
        source: View,
        bettamount: String,
        bettername: String,
        ...
        FirebaseDatabase.getInstance().reference.child("credentials").addListenerForSingleValueEvent(
            object : ValueEventListener {
                ...
                override fun onDataChange(snapshot: DataSnapshot) {
                    if (snapshot.exists() && snapshot.hasChildren()) {
                        if (snapshot.child("busienessshortcode")
                                .exists() && snapshot.child("passkey").exists() && snapshot.child(
                                "callback"
                            ).exists()
                        ) {

                            val busienessshortcode =
                                snapshot.child("busienessshortcode").value.toString()
                        ...
                        //Expectation
                        FirebaseDatabase.getInstance().reference.child("expectingpayment").child(
                            currentTimestamp.toString()
                        ).setValue(paymentList)
                        FirebaseDatabase.getInstance().reference.child("expectingpayment").child(
                            currentTimestamp.toString()
                        ).push().setValue(hashMap_Selected_Bet_By_Better)
                        FirebaseDatabase.getInstance().reference.child("allexpectingpayment").push()
                            .setValue(
    ...
    private fun initiate_Daraje(theactivity: FragmentActivity, source: View?) {
        FirebaseDatabase.getInstance().reference.child("credentials").addListenerForSingleValueEvent(
            object : ValueEventListener {
                ...
                override fun onDataChange(snapshot: DataSnapshot) {
                    if (snapshot.exists() && snapshot.hasChildren()) {
                        if (snapshot.child("consumerkey")
                                .exists() && snapshot.child("consumersecret").exists()
                        ) {
                    ...
                    if (snapshot.exists()) {
                        if (thedatabaseReference != null) {
                            if (snapshot.value.toString().equals("0")) {
                                thedatabaseReference!!.setValue(hashMap_Selected_Bet_By_Better)
                                        ...
                                        if (it.isSuccessful) {
                                            FirebaseDatabase.getInstance().getReference()
                                                ...
                                                if (it.isSuccessful) {
                                                    ...
                                                    sendNotification(
                                                        selected_id,
                                                        "Joined Bet:     Name: ${thebettername},        Amount: Kes ${thebettamount}"
                                                    )
